...
bp = Blueprint("new_assessment", __name__, url_prefix="/assessment")
...
def new_assessment():
    ...
    cursor().execute(f"INSERT INTO assessment (session_id, video_id, value, duration, time_in_video, timestamp) VALUES"
